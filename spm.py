...
if __name__ == "__main__":
    # train('/home/guest/JSObuAST/experiment1/data1/obfuscation_H/SEQ/char_corpus', 10000, 'high_10000', 'bpe', 1)
    # input_file, vocab_size, model_name, model_type, character_coverage, max_sentence_length
    train('/home/czx/pycharm/JSob/JSob_seq/origin/train/char_corpus1', 10000, 'JSob_origin_spm1', 'bpe', 1)
    # test('/home/qinyan/JSObuAST/transformer/medium_10000.model')
    print('done')
